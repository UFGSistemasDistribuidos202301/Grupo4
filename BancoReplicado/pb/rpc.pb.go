...
type QueuePendingCRDTStateRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Document *DocumentCRDTState `protobuf:"bytes,1,opt,name=document,proto3" json:"document,omitempty"`
	NodeID   uint64             `protobuf:"varint,2,opt,name=nodeID,proto3" json:"nodeID,omitempty"`
}

func (x *QueuePendingCRDTStateRequest) Reset() {
	*x = QueuePendingCRDTStateRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueuePendingCRDTStateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueuePendingCRDTStateRequest) ProtoMessage() {}

func (x *QueuePendingCRDTStateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueuePendingCRDTStateRequest.ProtoReflect.Descriptor instead.
func (*QueuePendingCRDTStateRequest) Descriptor() ([]byte, []int) {
	return file_rpc_proto_rawDescGZIP(), []int{6}
}

func (x *QueuePendingCRDTStateRequest) GetDocument() *DocumentCRDTState {
	if x != nil {
		return x.Document
	}
	return nil
...
func (x *QueuePendingCRDTStateRequest) GetNodeID() uint64 {
	if x != nil {
		return x.NodeID
	}
	return 0
...
type QueuePendingCRDTStateReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *QueuePendingCRDTStateReply) Reset() {
	*x = QueuePendingCRDTStateReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueuePendingCRDTStateReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueuePendingCRDTStateReply) ProtoMessage() {}

func (x *QueuePendingCRDTStateReply) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueuePendingCRDTStateReply.ProtoReflect.Descriptor instead.
func (*QueuePendingCRDTStateReply) Descriptor() ([]byte, []int) {
...
var file_rpc_proto_rawDesc = []byte{
	...
	,
}
...
var file_rpc_proto_goTypes = []interface{}{
	...
	(*QueuePendingCRDTStateRequest)(nil), // 6: banco_de_dados.QueuePendingCRDTStateRequest
	(*QueuePendingCRDTStateReply)(nil),   // 7: banco_de_dados.QueuePendingCRDTStateReply
...
var file_rpc_proto_depIdxs = []int32{
	...
	3,  // 6: banco_de_dados.QueuePendingCRDTStateRequest.document:type_name -> banco_de_dados.DocumentCRDTState
	...
	6,  // 10: banco_de_dados.Database.QueuePendingCRDTState:input_type -> banco_de_dados.QueuePendingCRDTStateRequest
	5,  // 11: banco_de_dados.Database.MergeCRDTStates:output_type -> banco_de_dados.MergeCRDTStatesReply
	7,  // 12: banco_de_dados.Database.QueuePendingCRDTState:output_type -> banco_de_dados.QueuePendingCRDTStateReply
...
func file_rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueuePendingCRDTStateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rpc_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueuePendingCRDTStateReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
